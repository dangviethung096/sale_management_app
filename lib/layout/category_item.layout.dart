...
class CategoryItemLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double widthSize = (screenWidth - 20 - (homePadding * 2)) / 2;
            ...
            children: [
              Row(
                children: [
                  SizedBox(width: 5),
                  CategoryItemImage(
                      linkImage: linkImages[0], edgeSize: edgeSize),
                  SizedBox(width: 5),
                  CategoryItemImage(
                      linkImage: linkImages[1], edgeSize: edgeSize),
                  SizedBox(width: 5),
                ],
              ),
              SizedBox(height: 5),
              Row(
                children: [
                  SizedBox(width: 5),
                  CategoryItemImage(
                      linkImage: linkImages[2], edgeSize: edgeSize),
                  SizedBox(width: 5),
                  CategoryItemImage(
                      linkImage: linkImages[3], edgeSize: edgeSize),
                  SizedBox(width: 5),
                ],
              ),
            ],
              ...
              children: [
                Row(
                  children: [
                    SizedBox(width: 5),
                    Text(title,
                        style: TextStyles.mediumTitle.copyWith(fontSize: 19)),
                  ],
                ),
                Row(
                  children: [
